...
- **NEXT — only Phase 0 security remains (owner action, in Supabase):** rotate the `admin@smithandadams.com` password and scrub/private the git history. Phase 1 of the unified backoffice (RE + Blog + Media native, legacy retired) is otherwise complete.
