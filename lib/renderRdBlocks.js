...
`      <section class="rd-sec rd-sec--navy">
  ...
  rd_msg(d, locale) {
    ...
    return (
`      <section class="rd-sec"${d.anchor ? ` id="${escAttr(d.anchor)}"` : ''} style="background:var(--paper);">
        <div class="rd-wrap">
          ...
          <div class="rd-msg">
            <figure class="rd-msg__figure reveal">
              <img src="${escAttr(d.photo || '')}" alt="${escAttr(pick(d.photo_alt, locale))}" loading="lazy" decoding="async"${d.photo_pos ? ` style="object-position:${escAttr(d.photo_pos)};"` : ''}>
