...
`      <section class="rd-sec${navy ? ' rd-sec--navy' : ''}"${navy ? '' : ' style="background:var(--paper);"'}>
  ...
  rd_team(d, locale) {
    ...
    const CSS = '<style>'
      ...
      + '.rd-team .rdt__ph:not(.rdt__ph--img)::after{content:"PHOTO";position:absolute;bottom:8px;left:0;right:0;text-align:center;font-size:8px;letter-spacing:.18em;color:var(--slate,#6A7883);opacity:.5;}'
